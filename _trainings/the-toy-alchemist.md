...
This is training for those that have little to no exposure to Elixir, Erlang, or even functional programming. It is meant to get developers excited about Elixir. It may not be best for all Elixir conferences but it is helpful for developers introduced to the language.
